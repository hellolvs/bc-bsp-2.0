...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	    ...
	    <div id="main">
	    	<h6>&nbsp;</h6><br/>
	    	<h2 style="color:#3CBFFF">OutNeighbor Search:<%=graphNames%></h2>
	    	<h5>&nbsp;</h5>
	    	<h2 style="color:#3CBFFF">Please input the vertex number here</h2>
	    	<h6>&nbsp;</h6><br/>
			<form name="form" action="edgeSearch.jsp" method="post"> 
			<table>
				<tr>
				<td><input type="text" id="vertexid1" name="vertexid1" style="border:1px solid #3CBFFF;height:30px" /></td>		
				<td><button type="submit" value="outgoingSearch" style='background:url(Images/Draw_Button_8.png);padding:0px 0 0px 0;border:0;width:150px;height:36px;'>search</button></td>				
				</tr>
			</table>
			</form>
			<h5>&nbsp;</h5>
			...
			<div style="border:2px solid #2D9EDB;width:1022px;height:490px">
			   ...
			   out.print(graphNames);
			   	 result = client.execute("g.V('vertexID','" + vertexNum1 + "').out('outgoing').map");
