...
public class PRBSPDriverNew {
  ...
  public static void main(String[] args) throws Exception {
    ...
    BSPJob bsp = new BSPJob(conf, PRBSPDriverNew.class);
    bsp.setJobName("PageRank-ByteArray");
    ...
    // Set the BSP.class
    bsp.setBspClass(PRBSPNew.class);
    // Set communication version
	bsp.setVertexClass(PRVertexLiteNew.class);
    bsp.setEdgeClass(PREdgeLiteNew.class);
    bsp.setInputFormatClass(KeyValueBSPFileInputFormat.class);
    bsp.setOutputFormatClass(TextBSPFileOutputFormat.class);
    bsp.setMessageClass(PageRankMessage.class);
