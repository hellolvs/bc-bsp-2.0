...
public class SSPDriver {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length < 4) {
      System.out
          .println("Usage:<SourceID>  <nSupersteps>  <FileInputPath>" +
              "  <FileOutputPath>  <SplitSize(MB)> <PartitionNum>" +
    ...
    bsp.setInt(SSPBSP.SOURCEID, Integer.parseInt(args[0]));
