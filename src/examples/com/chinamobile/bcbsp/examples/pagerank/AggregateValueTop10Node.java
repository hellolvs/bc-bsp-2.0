...
/**
 * AggregateValueTop10Node An example implementation of AggregateValue. To get
 * the top 10 pagerank node.
 *
 *
 *
 */
public class AggregateValueTop10Node extends
     AggregateValue<String, BSPMessage> {

  /**
   * In the form as follows: id1=pr1|id2=pr2|...|id10=pr10
   */
