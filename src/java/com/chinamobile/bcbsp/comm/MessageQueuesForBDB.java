...
public class MessageQueuesForBDB implements MessageQueuesInterface {
    ...
    public void outgoAMessage(String outgoingIndex, IMessage msg) {
        ConcurrentLinkedQueue<IMessage> outgoingQueue = outgoingQueues.get(outgoingIndex);
    ...
    @Override
    public ConcurrentLinkedQueue<IMessage> removeIncomedQueue(String dstVertexID) {
    ...
    @Override
    public ConcurrentLinkedQueue<IMessage> removeIncomingQueue(String dstVertexID) {
    ...
    public ConcurrentLinkedQueue<IMessage> removeOutgoingQueue(String index) {
        ...
        ConcurrentLinkedQueue<IMessage> outgoingQueue = outgoingQueues.remove(index);
    ...
    public IMessage getAMessage() {
    	...
    	String vertexID = this.incomingQueues.getMostFrequetKey();
    	
    	if(vertexID != null) {
    		return this.incomingQueues.aMessage(vertexID);
    	} else {
    		return null;
    	}
