...
public class UnsafeByteArrayOutputStream extends OutputStream implements
  ...
  /**
   * Constructor of UnsafeByteArrayOutputStream.
   */
   ...
   * Constructor of UnsafeByteArrayOutputStream.
   * @param size
   *        Initial size of the underlying byte array
   */
   ...
   * @param buf
   *        Buffer to start with, or if null, create own buffer
   */
   ...
   * @param pos
   *        Position to write at the buffer
   */
