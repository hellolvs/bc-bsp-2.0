...
public class UnsafeByteArrayInputStream implements ExtendedDataInput {
  ...
  private static final Logger LOG = Logger
      .getLogger(UnsafeByteArrayInputStream.class);
  ...
  private static final long LONG_ARRAY_OFFSET = UNSAFE
      .arrayBaseOffset(long[].class);
  /** Offset of a double array */
  private static final long DOUBLE_ARRAY_OFFSET = UNSAFE
  ...
  /**
   * Constructor of UnsafeByteArrayInputStream.
   * @param buf
   *        Buffer to read from
   */
   ...
   *        Buffer to read from
   * @param offset
   *        Offsetin the buffer to start reading from
   * @param length
   ...
   * @throws IOException
   *         When there are not enough bytes to read
   */
  ...
  public boolean readBoolean() throws IOException {
    ...
    boolean value = UNSAFE.getBoolean(buf, BYTE_ARRAY_OFFSET + pos);
  ...
  public byte readByte() throws IOException {
    ...
    byte value = UNSAFE.getByte(buf, BYTE_ARRAY_OFFSET + pos);
  ...
  public short readShort() throws IOException {
    ...
    short value = UNSAFE.getShort(buf, BYTE_ARRAY_OFFSET + pos);
  ...
  public char readChar() throws IOException {
    ...
    char value = UNSAFE.getChar(buf, BYTE_ARRAY_OFFSET + pos);
  ...
  public long readLong() throws IOException {
    ...
    long value = UNSAFE.getLong(buf, BYTE_ARRAY_OFFSET + pos);
  ...
  public float readFloat() throws IOException {
    ...
    float value = UNSAFE.getFloat(buf, BYTE_ARRAY_OFFSET + pos);
  ...
  public double readDouble() throws IOException {
    ...
    double value = UNSAFE.getDouble(buf, BYTE_ARRAY_OFFSET + pos);
