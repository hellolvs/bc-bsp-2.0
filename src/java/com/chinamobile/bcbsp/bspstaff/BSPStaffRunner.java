...
/**
 * BSPStaffRunner Base class that runs a staff in a separate process.
 * @author
 * @version
 */
public class BSPStaffRunner extends StaffRunner {
  ...
  /**
   * BSPStaffRunner extends the StaffRunner.
   * @param bspStaff one of the bspStaffs
   * @param wm the WorkerManager
