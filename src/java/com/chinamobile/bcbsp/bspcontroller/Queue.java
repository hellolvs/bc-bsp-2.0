...
public interface Queue<T> {
  ...
  void addJob(T job);
  /**
   * NEU change in version-0.2.4 new function: Sort jobs by priority and then by
   * start time.
   */
  ...
  /**
   * To judge whether this queue contains the job.
   * @param job
   *        to be judged in this queue.
   * @return true if this queue contains the job, otherwise return false.
   */
  boolean contains(T job);

  /**
   * get first jobInProgress information.
   * @return jobInprogress information
   */
