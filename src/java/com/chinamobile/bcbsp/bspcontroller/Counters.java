...
public class Counters implements Writable, Iterable<Counters.Group> {
  ...
  private static char[] charsToEscape = {GROUP_OPEN, GROUP_CLOSE, COUNTER_OPEN,
      COUNTER_CLOSE, UNIT_OPEN, UNIT_CLOSE};
   ...
   *        amount by which counter is to be incremented
   */
  public synchronized void incrCounter(String group,
  ...
  public void log(Log log) {
    ...
    for (Group group : this) {
      ...
      for (Counter counter : group) {
        ...
        countersmap.put(new Text(counter.getDisplayName()), new LongWritable(
            counter.getCounter()));
      }
    }
  }
