...
/**
 * SumVertexNumAggregator An example implementation of Aggregator. To do the sum
 * operation on vertex numbers.
 */
public class SumVertexNumAggregator extends
    Aggregator<AggregateValueVertexNum> {
  /**
