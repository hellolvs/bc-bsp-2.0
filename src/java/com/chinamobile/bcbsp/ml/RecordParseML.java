 ...
 */
public class RecordParseML extends RecordParse {
  /**The log of the class.*/
  private static final Log LOG = LogFactory.getLog(RecordParseML.class);
  ...
  public void init(BSPJob job) {
    //this.vertexClass = (Class<? extends Vertex<?, ?, ?>>) KeyValueVertex.class;
