...
/**
 * Fast queue implementation on top of Berkley DB Java Edition. This class is
 * thread-safe.
 */
public final class BDBList {
   ...
   */
  @SuppressWarnings("unchecked")
  public BDBList(final String dbEnvPath, final String dbName) {
    ...
    this.dbEnv = new Environment(new File(dbEnvPath), dbEnvConfig);
  ...
  public String getElement(int index) {
    ...
    final DatabaseEntry findKey = new DatabaseEntry(indexKey.toByteArray());
