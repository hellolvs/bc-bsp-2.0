...
class SumCombiner extends Combiner<BSPMessage> {
  public BSPMessage combine(Iterator<BSPMessage> messages) {
    ...
    msg = new BSPMessage(msg.getDstPartition(), msg.getDstVertexID(), newData
        .getBytes());
    return msg;
  }
}
...
public class CombinerToolTest {
  ...
  public void testRun() {
    ...
    assertEquals("Before combine, there are 3 messages in outgoingQueues.", 3,
